...
var Emitter = function () {
    ...
    return _inherits(C, Emitter), _createClass(C, null, [{
            ...
            if ("FORM" === this.element.tagName) {
                ...
                try {
                    for (var r, o = this.element.querySelectorAll("input, textarea, select, button")[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) {
                        ...
                        if (null != l) if ("SELECT" === a.tagName && a.hasAttribute("multiple")) {
        ...
        key: "_updateFilesUploadProgress", value: function (e, t, n) {
            if (void 0 !== n) {
                if (b = 100 * n.loaded / n.total, e[0].upload.chunked) {
                    var i = e[0], r = this._getChunk(i, t);
                    r.progress = b, r.total = n.total, r.bytesSent = n.loaded;
                    i.upload.progress = 0, i.upload.total = 0;
                    for (var o = i.upload.bytesSent = 0; o < i.upload.totalChunkCount; o++) void 0 !== i.upload.chunks[o] && void 0 !== i.upload.chunks[o].progress && (i.upload.progress += i.upload.chunks[o].progress, i.upload.total += i.upload.chunks[o].total, i.upload.bytesSent += i.upload.chunks[o].bytesSent);
                    ...
                    try {
                        for (var u, c = e[Symbol.iterator](); !(a = (u = c.next()).done); a = !0) {
                            var d = u.value;
                            d.upload.progress = b, d.upload.total = n.total, d.upload.bytesSent = n.loaded
                        }
                    } catch (e) {
                        l = !0, s = e
                    } finally {
                ...
                var g = !0, b = 100, k = !0, w = !1, F = void 0;
                try {
                    for (var z, x = e[Symbol.iterator](); !(k = (z = x.next()).done); k = !0) {
                        var E = z.value;
                        100 === E.upload.progress && E.upload.bytesSent === E.upload.total || (g = !1), E.upload.progress = b, E.upload.bytesSent = E.upload.total
                    }
                } catch (e) {
                    w = !0, F = e
                } finally {
...
Dropzone.initClass(), Dropzone.version = "5.7.0", Dropzone.options = {}, Dropzone.optionsForElement = function (e) {
    ...
    var s, e;
    return document.querySelectorAll ? s = document.querySelectorAll(".dropzones") : (s = [], (e = function (l) {
        return function () {
            var e = [], t = !0, n = !1, i = void 0;
            try {
                for (var r, o = l[Symbol.iterator](); !(t = (r = o.next()).done); t = !0) {
                    var a = r.value;
                    /(^| )dropzones($| )/.test(a.className) ? e.push(s.push(a)) : e.push(void 0)
                }
            } catch (e) {
                n = !0, i = e
            } finally {
