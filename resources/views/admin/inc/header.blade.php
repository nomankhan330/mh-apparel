...
<header class="page-header" role="banner">
    ...
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
            <img src="{{ asset('assets/admin/img/logo.png') }}" alt="SmartAdmin WebApp" aria-roledescription="logo">
    ...
    <div class="ml-auto d-flex" style="display: none;">
                        ...
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                <li class="unread">
                                    <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-c.png') }}')"></span>
                                                            </span>
                                ...
                                <li class="unread">
                                    <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-a.png') }}')"></span>
                                                            </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-b.png') }}')"></span>
                                                            </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-warning mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-e.png') }}')"></span>
                                                            </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                ...
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-h.png') }}')"></span>
                                                            </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-m.png') }}')"></span>
                                                            </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-danger mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-j.png') }}')"></span>
                                                            </span>
                                        <span class="d-flex flex-column flex-1 ml-1">
                                    ...
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        ...
                                        <div class="d-flex flex-column flex-1">
                                            ...
                                            <div class="fs-sm d-flex align-items-center mt-2">
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-a.png') }}'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-b.png') }}'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-c.png') }}'); background-size: cover;"></span>
                                                <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-e.png') }}'); background-size: cover;"></span>
                                                <div data-hasmore="+3" class="rounded-circle profile-image-md mr-1">
                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ asset('assets/admin/img/demo/avatars/avatar-h.png') }}'); background-size: cover;"></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex flex-column flex-1">
                                            ...
                                            <div class="fs-sm d-flex align-items-center mt-1">
                                                <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                    <span class="d-block img-share" style="background-image:url('{{ asset('assets/admin/img/thumbs/pic-7.png') }}'); background-size: cover;"></span>
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                    <span class="d-block img-share" style="background-image:url('{{ asset('assets/admin/img/thumbs/pic-8.png') }}'); background-size: cover;"></span>
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                    <span class="d-block img-share" style="background-image:url('{{ asset('assets/admin/img/thumbs/pic-11.png') }}'); background-size: cover;"></span>
                                                </a>
                                                <a href="#" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                    <span class="d-block img-share" style="background-image:url('{{ asset('assets/admin/img/thumbs/pic-12.png') }}'); background-size: cover;"></span>
                                                </a>
                                            </div>
                                            <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                        </div>
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="{{ asset('assets/admin/img/demo/avatars/avatar-admin.png') }}" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                ...
                <a class="dropdown-item fw-500 pt-3 pb-3" href="{{ url('admin/logout') }}">
                    ...
                    <span class="float-right fw-n">&commat;mh-apparel</span>
                </a>
            </div>
        </div>
    </div>
